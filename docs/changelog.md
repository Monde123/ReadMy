...
- Created the public `ReadMy` repository under `Monde123`.
- Defined the anonymized, content-first architecture.
- Added the anonymization and image policies.
- Added the first reference template: `001-minimal-clean`.

## 2026-09-23 — First template collection
